...
public abstract class DialogueFlow 
{
    ...
    {
        _panel.InitDialogue(_characters.Nestor, _characters.Bobbus);
        ...
        await _characters.Bobbus.Say("ouh là là ça fait mal ça aie aie aie caramba baba my world is upside down; cold sleep il all I found");

...
public class Df_Shop_CorruptionSpore : DialogueFlow
{
    public Df_Shop_CorruptionSpore(DialoguePanel panel, DialogueCharacters characters, MonoBehaviour WorldObject) : base(panel, characters, WorldObject) { }

    public override async Task StartDialogue()
    {
        _panel.InitDialogue(_characters.Quentin, _characters.Noah);

        await _characters.Noah.Say("Cet objet est très utile. Il d'ajouter de la corruption a une de tes plantes");

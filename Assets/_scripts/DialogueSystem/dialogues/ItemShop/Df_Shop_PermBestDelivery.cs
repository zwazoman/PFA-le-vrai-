...
public class Df_Shop_PermBestDelivery : DialogueFlow
{
    ...
    public override async Task StartDialogue()
    {
        ...
        if (resultat == 0)
        {
            ...
            {
                await _characters.Geoffrrus.Say("Charon te livrera désormais plus d’âmes chaque jours, à toi d’en prendre soin.");
                await _characters.Geoffrrus.Say("Oh, et ne te tracasse pas trop pour savoir comment il en trouve autant, tes semblables sont assez imaginatifs pour nous en fournir régulièrement en bonne quantité.");
        ...
        {
            await _characters.Geoffrrus.Say("NON MERCI ?! MAIS ! Ah, je ne comprendrais jamais votre espèce…");
        }

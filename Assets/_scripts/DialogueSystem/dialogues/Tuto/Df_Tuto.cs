    ...
    public override async Task StartDialogue()
    {
      ...
      //  await _characters.Bobbus.Say("… Je… Je ne suis pas vraiment sûr de…ce que je fais là, en premier lieu ?");
       ...
       // await _characters.Bobbus.Say("….");
        ...
        await _characters.Charon.Say("#Arrosez les#, et après quelques jours vous obtiendrez un bel #orbe d’âme# toute pure que vous n’aurez qu’à récolter avec une faux et apporter au #moulin# pour finir l’opération.");

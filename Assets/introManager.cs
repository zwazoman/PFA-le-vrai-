...
public class introManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //movement bateau
        StartCoroutine(Nathan.InterpolateOverTime(1, 0.329f, _animationDuration, bateau.setPositionAlongCurve, (v) => { return _boatMovementCurve.Evaluate(v); }, sequence, false));
    }

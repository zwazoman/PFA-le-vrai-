...
public class Tooling : MonoBehaviour
{
    ...
    /// <returns></returns>
    public static IEnumerator InterpolateOverTime(float from, float to, float duration, ValueSetter valueSetter, AlphaInterpolation Interpolation = null,Action onEnd = null)
    {
